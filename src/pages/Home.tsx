      ...
      <section className="container mx-auto py-20 px-4">
        <div className="flex flex-col items-center lg:flex-row lg:items-start">
          ...
          <div className="w-full lg:w-2/3 text-center lg:text-left px-4 lg:px-0">
            ...
            <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="bg-green-300 text-gray-900 px-6 py-3 rounded-full text-lg font-semibold hover:bg-green-400 transition duration-300 inline-flex items-center">
              View on GitHub
      ...
      <section className="bg-gray-800 py-20">
        <div className="container mx-auto text-center">
          ...
          <div className="flex justify-center space-x-8 mb-12">
            {[
              { name: 'Navnath', role: 'Software Developer', image: '/Navnath.jpg' },
      ...
      <footer className="bg-gray-900 py-12">
        <div className="container mx-auto text-center">
          <div className="flex justify-center space-x-6 mb-8">
            <a href="https://github.com/navnathjadhav08" className="text-green-300 hover:text-green-400 text-2xl"><FontAwesomeIcon icon={faGithub} /></a>
            <a href="https://x.com/" className="text-green-300 hover:text-green-400 text-2xl"><FontAwesomeIcon icon={faXTwitter} /></a>
            <a href="https://www.linkedin.com/in/navnath-jadhav-/" className="text-green-300 hover:text-green-400 text-2xl"><FontAwesomeIcon icon={faLinkedin} /></a>
          </div>
          <p>
            Crafted by <span className="text-green-300 font-semibold">Navnath</span> with <span className="text-green-300 font-semibold">Typescript</span>
          </p>
        </div>
      </footer>
